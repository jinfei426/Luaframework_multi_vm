...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetUniType", GetUniType);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetUniType(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			System.Type o = LuaFramework.LuaHelper.GetUniType(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetComponent(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Object o = LuaFramework.LuaHelper.GetComponent(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetPanelManager(IntPtr L)
	{
		try
		{
			...
			LuaFramework.PanelManager o = LuaFramework.LuaHelper.GetPanelManager(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetResManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 1);
			LuaFramework.ResourceManager o = LuaFramework.LuaHelper.GetResManager(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
