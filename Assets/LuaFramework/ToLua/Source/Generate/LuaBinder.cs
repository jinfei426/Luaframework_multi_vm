...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		GlobalVarWrap.Register(L);
		ViewWrap.Register(L);
		BaseWrap.Register(L);
		ManagerWrap.Register(L);
		L.RegFunction("EventHandler", EventHandler);
	...
	static int EventHandler(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<EventHandler>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<EventHandler>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
