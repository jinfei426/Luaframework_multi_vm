...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(EventHandler), factory.EventHandler);
		...
		DelegateTraits<EventHandler>.Init(factory.EventHandler);
		...
		TypeTraits<EventHandler>.Init(factory.Check_EventHandler);
		...
		StackTraits<EventHandler>.Push = factory.Push_EventHandler;
	...
	class EventHandler_Event : LuaDelegate
	{
		public EventHandler_Event(LuaFunction func) : base(func) { }
		public EventHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public EventHandler EventHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			EventHandler fn = delegate(object[] param0) { };
			return fn;
		}

		if(!flag)
		{
			EventHandler_Event target = new EventHandler_Event(func);
			EventHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			EventHandler_Event target = new EventHandler_Event(func, self);
			EventHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_EventHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(EventHandler), L, pos);
	}

	void Push_EventHandler(IntPtr L, EventHandler o)
	{
		ToLua.Push(L, o);
	}
